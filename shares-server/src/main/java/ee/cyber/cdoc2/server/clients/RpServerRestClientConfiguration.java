...
@Configuration
public class RpServerRestClientConfiguration {
    ...
    @ConfigurationProperties(prefix = "app.restclient.rp-server")
    ...
    @Bean
    public RestClient rpServerRestClient(AppProperties props, SslBundles sslBundles)
