...
keytool -import -noprompt -v -trustcacerts -keystore test_trusted_issuers.jks \
...
keytool -import -noprompt -v -trustcacerts -file tsp_demo_sk_ee_2025.pem.cer \
 -keystore test_trusted_issuers.jks -alias tsp-demo-sk-ee-2025 -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file EID_NQ_2021E.pem.crt \
 -keystore test_trusted_issuers.jks -alias EID-NQ-2021E -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file EID_NQ_2021R.pem.crt \
 -keystore test_trusted_issuers.jks -alias EID-NQ-2021R -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file EID_Q_2021E.pem.crt \
 -keystore test_trusted_issuers.jks -alias EID-Q-2021E -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file EID_Q_2021R.pem.crt \
 -keystore test_trusted_issuers.jks -alias EID-Q-2021R -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file EID_Q_2024E.pem.crt \
 -keystore test_trusted_issuers.jks -alias EID-Q-2024E -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file EID_Q_2024R.pem.crt \
 -keystore test_trusted_issuers.jks -alias EID-Q-2024R -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file SK_ID_Solutions_ROOT_G1E.pem.crt \
 -keystore test_trusted_issuers.jks -alias SK_ROOT_G1E -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file SK_ID_Solutions_ROOT_G1R.pem.crt \
 -keystore test_trusted_issuers.jks -alias SK_ROOT_G1R -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file EID-SK_2016.pem.crt \
 -keystore test_trusted_issuers.jks -alias EID-SK-2016 -storepass changeit
...
-keystore test_trusted_issuers.jks -alias ESTEID-SK-2015 -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file NQ-SK_2016.pem.crt \
 -keystore test_trusted_issuers.jks -alias NQ-SK-2016 -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file EE_Certification_Centre_Root_CA.pem.crt \
 -keystore test_trusted_issuers.jks -alias Centre_Root_CA -storepass changeit
...
keytool -import -noprompt -v -trustcacerts \
 ...
 -keystore test_trusted_issuers.jks -alias TEST-EID-NQ-2021E -storepass changeit
...
keytool -import -noprompt -v -trustcacerts \
 ...
 -keystore test_trusted_issuers.jks -alias TEST-EID-NQ-2021R -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file TEST_EID-Q_2021E.pem.crt \
 -keystore test_trusted_issuers.jks -alias TEST-EID-Q-2021E -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file TEST_EID-Q_2021R.pem.crt \
 -keystore test_trusted_issuers.jks -alias TEST-EID-Q-2021R -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file TEST_of_SK_ID_Solutions_EID-Q_2024E.pem.crt \
 -keystore test_trusted_issuers.jks -alias TEST-EID-Q-2024E -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file TEST_of_SK_ID_Solutions_EID-Q_2024R.pem.crt \
 -keystore test_trusted_issuers.jks -alias TEST-EID-Q-2024R -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file TEST_SK_ROOT_G1_2021E.pem.crt \
 -keystore test_trusted_issuers.jks -alias TEST_SK_ROOT_G1_2021E -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file TEST_SK_ROOT_G1_2021R.pem.crt \
 -keystore test_trusted_issuers.jks -alias TEST_SK_ROOT_G1_2021R -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file 'TEST of EID-SK 2016_reissued.pem' \
 -keystore test_trusted_issuers.jks -alias TEST-EID-SK-2016 -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file TEST_of_ESTEID-SK_2015.pem.crt \
 -keystore test_trusted_issuers.jks -alias TEST-ESTEID-SK-2015 -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file 'TEST of NQ-SK 2016_reissued.pem' \
 -keystore test_trusted_issuers.jks -alias TEST-NQ-SK-2016 -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file TEST_of_EE_Certification_Centre_Root_CA.pem.crt \
 -keystore test_trusted_issuers.jks -alias TEST-Centre-Root-CA \
 -storepass changeit
...
keytool -import -noprompt -v -trustcacerts -file sk-ca.localhost.crt \
 -keystore test_trusted_issuers.jks -alias sk-ca.localhost -storepass changeit
...
-keystore test_trusted_issuers.jks -alias cyber-ca.localhost -storepass changeit
