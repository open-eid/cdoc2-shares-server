...
public final class TestData {
    ...
    @SneakyThrows
    public static String pemCertToBase64Url(String pemCert) {
        X509Certificate cert = X509CertUtils.parseWithException(pemCert);
        return Base64.getUrlEncoder().encodeToString(cert.getEncoded());
    }

    /**
     * Generate Auth token with TestData.TEST_RSAKEY.
     * Deprecated, cdoc2-auth-token versions 0.5.0+ will not accept tokens generated by this method
     *
    ...
    @SneakyThrows
    @Deprecated
    public static String generateTestAuthToken(String eid, String serverUrl, String shareId, String nonce) {
